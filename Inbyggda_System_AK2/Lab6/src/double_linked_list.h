...
typedef struct doubleLinkedListElement dNode_t;
...
typedef struct doubleLinkedList head_t;
...
/*
 * This function should Give us the previous value  
 */
int get_previous_value(struct doubleLinkedList* list, int value);
