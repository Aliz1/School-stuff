...
struct singleLinkedListElement{
  struct travel_need data;
  struct travel_need origin;
  struct travel_need destination;
  struct singleLinkedListElement *next;
};
typedef struct singleLinkedListElement node_t;

struct singleLinkedList{
  struct singleLinkedListElement *first;
};
typedef struct singleLinkedList list_t;
 ...
 */
struct travel_need addElementSingleLinkedList(struct singleLinkedList* list, struct travel_need value);
